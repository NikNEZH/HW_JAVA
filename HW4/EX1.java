...
private static void heapify(int[] sortArr, int i, int size) {
    ...
    // методо от максимума до минимума 
    // if (left < size && sortArr[i] > sortArr[left]) largest = left;
    // if (right < size && sortArr[largest] > sortArr[right ]) largest = right;

    // методо от минимума до максимума
